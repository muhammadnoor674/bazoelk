...
wget -O trojaan "https://raw.githubusercontent.com/muhammadnoor674/bazoelk/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/muhammadnoor674/bazoelk/main/menu/xraay.sh"
chmod +x port-xray
chmod +x certv2ray
chmod +x trojaan
chmod +x xraay
