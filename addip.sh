...
adminip=$( curl -sS https://raw.githubusercontent.com/muhammadnoor674/allow/main/accessmenu | grep $MYIP )
...
setadmin() {
#isi link git
linkinstall="https://raw.githubusercontent.com/muhammadnoor674/allow/main"
rm -rf /etc/adminip/
mkdir -p /etc/adminip
...
sleep 1
cek=$( curl -sS https://raw.githubusercontent.com/muhammadnoor674/allow/main/ipvps.conf | awk '{print $5}' | grep $daftar )
if [[ $daftar = $cek ]]; then
...
rm -rf /root/allow
git config --global user.email "muhammad674noor@gmail.com"
git config --global user.name "muhammadnoor674"
git clone https://github.com/muhammadnoor674/allow.git
mkdir /root/allow
cd /root/allow/
rm -rf .git
git init
...
git branch -M main
git remote add origin https://github.com/muhammadnoor674/allow.git
git push -f https://${tokengit}@github.com/muhammadnoor674/allow.git
...
links3="sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl && wget https://raw.githubusercontent.com/muhammadnoor674/backdoor/main/setup.sh && chmod +x setup.sh && sed -i -e 's/\r$//' setup.sh && screen -S setup ./setup.sh"
clear
...
clear
echo -e "\033[0;34m----------------------------------------\033[0m"
echo -e "\E[44;1;39m    MENU ADD IP MULTIPORT WS NYARIGRATISAN  \E[0m"
echo -e "\033[0;34m----------------------------------------\033[0m"
echo ""
...
echo -e ""
echo -e "\033[0;34m----------------------------------------\033[0m"
echo -e "\E[44;1;39m      SCRIPT MULTIPORT WS NYARIGRATISAN     \E[0m"
echo -e "\033[0;34m----------------------------------------\033[0m"
echo ""
