...
cd 
wget -O /usr/local/bin/ohps "https://raw.githubusercontent.com/muhammadnoor674/bazoelk/main/ohps"
chmod +x /usr/local/bin/ohps

#Buat Service Untuk OHP SSH
cat > /etc/systemd/system/ohps.service <<END
[Unit]
Description=Direct Squid Proxy For open-ssh By NYARIGRATISAN
