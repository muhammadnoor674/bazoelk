...
state="Kelantan"
locality="Kota Bharu"
organization="@anuybazoelk"
organizationalunit="@anuybazoelk"
commonname="NYARIGRATISAN"
email="admin@nyarigratisan.eu.org"

# // simple password minimal
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/muhammadnoor674/bazoelk/main/password"
...
# // install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/muhammadnoor674/bazoelk/main/badvpn-udpgw64"
...
apt -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/muhammadnoor674/bazoelk/main/squid3.conf"
...
# // OpenVPN
wget https://raw.githubusercontent.com/muhammadnoor674/bazoelk/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh

# // install lolcat
wget https://raw.githubusercontent.com/muhammadnoor674/bazoelk/main/lolcat.sh &&  chmod +x lolcat.sh && ./lolcat.sh
