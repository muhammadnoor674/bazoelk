...
############## WELCOME TO NYARIGRATISAN ###############
############## By NYARIGRATISAN ###############
setenv FRIENDLY_NAME "NYARIGRATISAN TCP"
client
dev tun
proto tcp
remote $domain 1194
...
############## WELCOME TO NYARIGRATISAN ###############
############## By NYARIGRATISAN ###############
setenv FRIENDLY_NAME "NYARIGRATISAN UDP"
client
dev tun
proto udp
remote $domain 2200
...
setenv FRIENDLY_NAME "NYARIGRATISAN OHP"
http-proxy $MYIP $vpn
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By NYARIGRATISAN
...
############## WELCOME TO NYARIGRATISAN ###############
############## BY NYARIGRATISAN ###############
setenv FRIENDLY_NAME "NYARIGRATISAN SSL"
client
dev tun
proto tcp
remote $domain $vpn
